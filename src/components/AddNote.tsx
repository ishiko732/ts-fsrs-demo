  ...
  return (
    <>
      <div className="operator-option">
        ...
        <svg width="96" height="96" className={"w-6 h-6 hover:fill-amber-400 dark:fill-white"} xmlns="http://www.w3.org/2000/svg"  clip-rule="evenodd"><path d="M11 11v-11h1v11h11v1h-11v11h-1v-11h-11v-1h11z"/></svg>
        </i>
        <i onClick={handleSearchOpenClick} className="w-6 h-6 inline-block hover:cursor-pointer">
          <svg clip-rule="evenodd"
           width="96" height="96"
          className={"w-12 h-12 hover:fill-amber-400 dark:fill-white"}
